...
public class WebSocketWebSocketCommandMapperIT {
    ...
    void toBytes() {
        ...
        WebSocketCommand<byte[]> webSocketEvent = new WebSocketCommand<>(timestamp, name, payload);
    ...
    void fromBytes() throws BinaryDecodingException {
        ...
        WebSocketCommand<byte[]> result = mapper.fromBytes(eventBytes);
